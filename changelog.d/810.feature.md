...
See [Constraining Automatic Execution](https://devopstoolkit.ai/docs/ai-engine/tools/remediate#constraining-automatic-execution) for what the constraint covers, what it deliberately does not, and what the default leaves open.
