...
See [Untrusted Content](https://devopstoolkit.ai/docs/mcp/ai-engine/operations/untrusted-content) for what the boundary covers, what `evidence` is for, and what it does and does not guarantee.
