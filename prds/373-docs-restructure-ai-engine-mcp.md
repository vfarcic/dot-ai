...
│   │
│   ├── tools/                               # Renamed from capabilities/ to avoid collision with Capability Management tool
│   │   ├── _category_.yml
│   │   ├── overview.md                   # Tools catalog (from guides/mcp-tools-overview.md)
...
│   ├── _category_.yml
│   └── index.md                          # MCP landing + client setup (merged — separate landing was too thin)
│
...
| `setup/mcp-setup.md` | `ai-engine/setup/deployment.md` + `mcp/index.md` | Split: server deployment vs MCP client config |
| `setup/gateway-api.md` | `ai-engine/setup/gateway-api.md` | Moved |
| `guides/mcp-tools-overview.md` | `ai-engine/tools/overview.md` | Renamed, remove MCP framing |
| `guides/mcp-query-guide.md` | `ai-engine/tools/query.md` | Renamed |
| `guides/mcp-recommendation-guide.md` | `ai-engine/tools/recommend.md` | Renamed |
| `guides/mcp-operate-guide.md` | `ai-engine/tools/operate.md` | Renamed |
| `guides/mcp-remediate-guide.md` | `ai-engine/tools/remediate.md` | Renamed |
| `guides/mcp-knowledge-base-guide.md` | `ai-engine/tools/knowledge-base.md` | Renamed |
| `guides/mcp-capability-management-guide.md` | `ai-engine/tools/capability-management.md` | Renamed |
| `guides/mcp-project-setup-guide.md` | `ai-engine/tools/project-setup.md` | Renamed |
| `guides/mcp-prompts-guide.md` | `ai-engine/tools/prompts.md` | Renamed |
| `guides/mcp-version-guide.md` | `ai-engine/tools/version.md` | Renamed |
...
| *(new)* | `mcp/index.md` | New: MCP landing + client config (merged) |
