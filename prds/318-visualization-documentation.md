...
- [ ] Document `WEB_UI_BASE_URL` in Helm chart values
- [ ] Add configuration example to deployment docs
- [ ] Explain feature toggle behavior (disabled when not set)

### Milestone 2: Tool Output Documentation
- [ ] Update query tool output examples to show `sessionId` and `visualizationUrl`
- [ ] Document the URL format and what it links to
- [ ] Add note about Web UI requirement for visualization viewing

### Milestone 3: Web UI Cross-References
- [ ] Add link to Web UI documentation/repo
- [ ] Brief explanation of visualization capabilities
- [ ] User journey from MCP tool → Web UI visualization
