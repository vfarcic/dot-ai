...
The narwhal metrics server collects and aggregates resource utilization data for intelligent scaling decisions.`;
      ...
      const ingestResponse =
        await integrationTest.httpClient.post<KnowledgePayload>(
      ...
      const searchBeforeDeleteBySource =
        await integrationTest.httpClient.post<KnowledgePayload>(
          '/api/v1/tools/manageKnowledge',
          {
            operation: 'search',
      ...
      const deleteBySourceResponse =
        await integrationTest.httpClient.delete<KnowledgePayload>(
      ...
      const searchAfterDeleteBySource =
        await integrationTest.httpClient.post<KnowledgePayload>(
          '/api/v1/tools/manageKnowledge',
          {
            operation: 'search',
...
Employees must return company vehicles with at least half a tank of fuel.`;
      ...
      const response = await integrationTest.httpClient.post<KnowledgePayload>(
