...
export class RecommendationComparativeEvaluator extends BaseComparativeEvaluator {
  ...
  readonly description =
    'Compares multiple AI models on Kubernetes deployment recommendation scenarios';
  ...
  getEvaluationPhases(): {
    ...
    const phaseDescriptions: Record<string, string> = {
      clarification_phase:
        'Intent Analysis Phase - How well each model analyzes user intents and identifies missing context',
      question_generation:
        'Question Generation Phase - How well each model generates clarifying questions to enhance requirements',
      solution_assembly:
        'Solution Assembly Phase - How well each model selects appropriate Kubernetes resources and deployment patterns',
      generate_manifests_phase:
        'Manifest Generation Phase - How well each model generates production-ready Kubernetes manifests',
    };
