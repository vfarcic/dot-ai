 ...
 * Extensible for future providers (bedrock, mistral, groq, ollama, etc.)
 */
 ...
 *
 * Phase 1: ANTHROPIC_API_KEY, OPENAI_API_KEY, GOOGLE_API_KEY
...
export const PROVIDER_ENV_KEYS: Record<string, string> = {
  ...
  // Future providers:
  // bedrock: 'AWS_ACCESS_KEY_ID', // Special case - needs multiple env vars
  // mistral: 'MISTRAL_API_KEY',
  // groq: 'GROQ_API_KEY',
  // ollama: 'OLLAMA_BASE_URL', // Local provider - different pattern
};

/**
 * Providers implemented in Phase 1 (PRD 73)
 */
export const IMPLEMENTED_PROVIDERS = ['anthropic', 'openai', 'google'] as const;

/**
 * Type for Phase 1 implemented providers
 */
