...
export const STAGE_MESSAGES = {
  ...
  REQUIRED_INSTRUCTIONS:
    'STAGE: REQUIRED - Present ALL questions to the user and collect answers. All questions must be answered before proceeding.',
  BASIC_INSTRUCTIONS:
    'STAGE: BASIC - Present ALL questions to the user. Show defaults where available but ask user to confirm or change each one. User must review all questions before proceeding to advanced stage.',
  ...
  OPEN_INSTRUCTIONS:
    'STAGE: OPEN - Final configuration stage. Ask user for any additional requirements or constraints. User can say "N/A" if none.',
  UNKNOWN_INSTRUCTIONS:
    'STAGE: UNKNOWN - Present questions to the user and wait for their response.',
   ...
   */
  REQUIRED_GUIDANCE:
    'Present all required questions to the user. All must be answered to proceed.',
  BASIC_GUIDANCE:
    'Present all basic questions to the user. Show default values as suggestions but ask user to confirm each one.',
  ADVANCED_GUIDANCE:
  ...
  OPEN_GUIDANCE:
    'Ask user for any additional requirements or constraints. User can say "N/A" if none.',
  DEFAULT_GUIDANCE:
    'Present all questions to the user and collect their responses.',
} as const;
