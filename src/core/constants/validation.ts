...
export const VALIDATION_MESSAGES = {
   ...
   */
  MISSING_PARAMETER_WITH_CONTEXT: (param: string, context: string) =>
    `Missing required parameter: ${param} (${context})`,
  ...
  INVALID_INPUT: (details?: string) =>
    details ? `Invalid input provided: ${details}` : 'Invalid input provided',
} as const;
