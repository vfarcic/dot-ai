...
export const ORGANIZATIONAL_DATA_TOOL_INPUT_SCHEMA = {
  ...
  limit: z.number().int().optional().describe('Maximum number of items to return (must be an integer; default: 10, maximum: 10000). A list is truncated when returnedCount < totalCount; the response also carries an explicit truncated flag.'),
