 ...
 */
const PUSH_TO_GIT_PR_ONLY_ACTION = {
  action: 'pushToGit',
  description:
...
/**
 * Build the nextActions list, presenting only the push mode the caller is
 * permitted to use (PRD #710 Milestone 3).
 */
export function buildNextActions(applyAllowed: boolean) {
  return [
    SAVE_LOCALLY_ACTION,
    DEPLOY_MANIFESTS_ACTION,
    applyAllowed ? PUSH_TO_GIT_ACTION : PUSH_TO_GIT_PR_ONLY_ACTION,
  ];
}
